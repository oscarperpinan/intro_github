...
\label{sec:orge1fece9}
\subsection{¿Qué es el control de versiones?}
\label{sec:org10716f9}

\begin{frame}[label={sec:org2199467},plain]{}
\begin{center}
...
\begin{frame}[label={sec:org5cc8e2d},plain]{}
\begin{center}
...
\begin{frame}[label={sec:orgbbf7112},plain]{}
\begin{center}
...
\begin{frame}[label={sec:org7f95117}]{¿Qué es el control de versiones y por qué debería importarte?}
\begin{quote}
...
\begin{frame}[label={sec:org6a45ca6}]{¿Qué es el control de versiones y por qué debería importarte?}
\begin{quote}
...
\begin{frame}[label={sec:org23e26dd}]{Viajar en el tiempo}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org7bcd1f1}]{¿Qué? ¿Cuándo? ¿Quién?}
...
\begin{frame}[label={sec:org5bc9f23}]{Trabajo Colaborativo}
\begin{itemize}
...
\label{sec:org21f2332}

\begin{frame}[label={sec:org979c005},fragile]{Git es un Sistema de Control de Versiones}
...
\begin{frame}[label={sec:orgaed6b8e}]{Git es un Sistema de Control de Versiones}
...
\begin{frame}[label={sec:org96ef695}]{Git es un Sistema de Control de Versiones}
...
\begin{frame}[label={sec:org6558001}]{Los estados de Git}
\begin{itemize}
...
\begin{frame}[label={sec:orgdd1a183},fragile]{¿Qué es GitHub?}
 \begin{itemize}
...
\label{sec:orgc53798b}

\begin{frame}[label={sec:org1bfa74e}]{Creación de una cuenta en GitHub}
...
\begin{frame}[label={sec:org4dd1e2a}]{Instalación de GitHub Desktop}
...
\begin{frame}[label={sec:org2746cf3}]{Conectamos Git, GitHub y GitHub Desktop}
\begin{itemize}
...
\begin{frame}[label={sec:org2e5b9b6}]{Nuevo repositorio desde github.com}
...
\begin{frame}[label={sec:orgc02aaa1}]{Nuevo repositorio desde GitHub Desktop}
\begin{center}
...
\begin{frame}[label={sec:org27a1199}]{Clonar un repositorio remoto}
...
\begin{frame}[label={sec:org8f29555}]{Publicar un repositorio local}
...
\begin{frame}[label={sec:org7294053}]{Combinación de código}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/branching.png}
\end{center}
...
\begin{frame}[label={sec:org108ee76}]{Combinación de código}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/branching.png}
\end{center}
