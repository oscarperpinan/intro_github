...
\label{sec:orgc765629}
\subsection{¿Qué es el control de versiones?}
\label{sec:org72b7718}

\begin{frame}[label={sec:org7788c5c},plain]{}
\begin{center}
...
\begin{frame}[label={sec:orgb6778ef},plain]{}
\begin{center}
...
\begin{frame}[label={sec:orgf3787e2},plain]{}
\begin{center}
...
\begin{frame}[label={sec:orgd708a2f}]{¿Qué es el control de versiones y por qué debería importarte?}
\begin{quote}
...
\begin{frame}[label={sec:orgc45a18c}]{¿Qué es el control de versiones y por qué debería importarte?}
\begin{quote}
...
\begin{frame}[label={sec:orgaac6ced}]{Viajar en el tiempo}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org27a92e1}]{¿Qué? ¿Cuándo? ¿Quién?}
...
\begin{frame}[label={sec:org5cc8492}]{Trabajo Colaborativo}
\begin{itemize}
...
\label{sec:org4010f63}

\begin{frame}[label={sec:org813f134},fragile]{Git es un Sistema de Control de Versiones}
...
\begin{frame}[label={sec:orge95b6ef}]{Git es un Sistema de Control de Versiones}
...
\begin{frame}[label={sec:org381e73b}]{Git es un Sistema de Control de Versiones}
...
\begin{frame}[label={sec:org2137dcd}]{Los estados de Git}
\begin{itemize}
...
\begin{frame}[label={sec:org4148228},fragile]{¿Qué es GitHub?}
 \begin{itemize}
...
\label{sec:orgdbf2b4a}

\subsection{Primeros Pasos}
\label{sec:org611342f}
\begin{frame}[label={sec:orgde7bda3}]{Creación de una cuenta en GitHub}
...
\begin{frame}[label={sec:org10737a9}]{Instalación de GitHub Desktop}
...
\begin{frame}[label={sec:org19a308e}]{Conectamos Git, GitHub y GitHub Desktop}
\begin{itemize}
...
\begin{frame}[label={sec:org162f4cc}]{Nuevo repositorio desde github.com}
...
\begin{frame}[label={sec:orgfca1d62}]{Nuevo repositorio desde GitHub Desktop}
\begin{center}
...
\begin{frame}[label={sec:org5efbd3d}]{Clonar un repositorio remoto}
...
\begin{frame}[label={sec:orgc89b2c9}]{Publicar un repositorio local}
...
\begin{frame}[label={sec:org5eb001b},fragile]{Consejos básicos}
 \begin{itemize}
...
\label{sec:orgdbea7a0}

\begin{frame}[label={sec:org6c0e9ac},fragile]{Cambios en la copia local}
 \begin{itemize}
...
\begin{frame}[label={sec:orga2ccc9c},fragile]{Histórico de cambios}
...
\begin{frame}[label={sec:org8abcb09},fragile]{Publicar cambios al repositorio remoto}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org5b2a720},fragile]{Recibir cambios de un repositorio remoto}
...
\label{sec:org091d21c}

\subsection{Ramas}
\label{sec:org6782e3e}

\begin{frame}[label={sec:org6abebea},fragile]{Rama \texttt{master}}
 \begin{center}
...
\begin{frame}[label={sec:org2c728df}]{Ramas para facilitar la colaboración}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/branching.png}
\end{center}
...
\begin{frame}[label={sec:org9488c76}]{Combinación de código}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/branching.png}
\end{center}
...
\begin{frame}[label={sec:orgb8dd642}]{Combinación de código}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/branching.png}
\end{center}
...
\begin{frame}[label={sec:orga92eaca}]{Resolución de conflictos}
...
\begin{frame}[label={sec:org0a04abb}]{Consejos}
\begin{itemize}
...
\label{sec:org48b1de3}
\subsection{Herramientas gráficas para el análisis de un repositorio}
\label{sec:org3ab303c}

\begin{frame}[label={sec:orga6f7d27}]{Insights}
...
\begin{frame}[label={sec:orga81d330}]{Contribución de los integrantes del equipo}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/repo_contributors_specific_graph.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:org751c23a}]{Estructura de ramas de un repositorio}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/repo_network_graph.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgc6f67e1}]{Cambios en un repositorio}
\begin{center}
...
\label{sec:orgbca096b}

\begin{frame}[label={sec:org30b24c3},fragile]{Página web de usuario u organización}
 \begin{enumerate}
...
\begin{frame}[label={sec:orgba4c904},fragile]{Página web de proyecto}
...
\begin{frame}[label={sec:orgde96de4},fragile]{Página web de proyecto}
