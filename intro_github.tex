...
\begin{frame}[label={sec:orgf7c45e7}]{AIGORA}
...
\label{sec:org9ad0498}
\subsection{¿Qué es el control de versiones?}
\label{sec:org8bae056}

\begin{frame}[label={sec:orgbd1e2d0},plain]{}
\begin{center}
...
\begin{frame}[label={sec:orgcaf04d7},plain]{}
\begin{center}
...
\begin{frame}[label={sec:org589c81b},plain]{}
\begin{center}
...
\begin{frame}[label={sec:org58efe1a}]{¿Qué es el control de versiones y por qué debería importarte?}
\begin{quote}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgac4d6c5}]{¿Qué es el control de versiones y por qué debería importarte?}
\begin{quote}
...
personas.\footnote{\url{https://swcarpentry.github.io/git-novice/}\label{org2f52613}}
\end{quote}
...
\begin{frame}[label={sec:org86ab9bd}]{Git es un Sistema de Control de Versiones}
...
\begin{frame}[label={sec:org4b2018c}]{Git es un Sistema de Control de Versiones}
...
\begin{frame}[label={sec:orgdc6ed83}]{Los estados de Git}
\begin{itemize}
...
\begin{frame}[label={sec:orgad1dcf8},fragile]{¿Qué es GitHub?}
 \begin{itemize}
...
\label{sec:org60cc581}

\subsection{Primeros Pasos}
\label{sec:orgad0e8d0}
\begin{frame}[label={sec:orgc361b89}]{Creación de una cuenta en GitHub}
...
\begin{frame}[label={sec:orgd101510}]{Instalación de GitHub Desktop}
...
\begin{frame}[label={sec:orgc7c757e}]{Método 1: de remoto a local}
...
\begin{frame}[label={sec:org3e67795},fragile]{Cambios en la copia local}
 \begin{center}
\includegraphics[height=0.4\textheight]{figs/git_estados.png}
\end{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org4363ca3},fragile]{Cambios en la copia local}
 \begin{center}
\includegraphics[height=0.4\textheight]{figs/git_estados.png}
\end{center}
...
\end{center}
\end{frame}
\begin{frame}[label={sec:org6848f31},fragile]{Consejos para \texttt{commit}}
 \begin{itemize}
...
\begin{frame}[label={sec:org22e3723}]{Combinación de código}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/branching.png}
\end{center}
...
\begin{frame}[label={sec:org1082944}]{Combinación de código}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/branching.png}
\end{center}
...
\begin{frame}[label={sec:org7fff53e}]{Resolución de conflictos}
...
\end{frame}
\begin{frame}[label={sec:org955043b},fragile]{Consejos}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgfb3e4af},fragile]{}
...
\label{sec:org75f3571}

\begin{frame}[label={sec:orga10c148}]{Issues}
...
\begin{frame}[label={sec:org3712851}]{Estructura de una issue}
...
\begin{frame}[label={sec:org4edd3f6}]{Contenido de una issue}
\begin{itemize}
...
\begin{frame}[label={sec:org15ed2ed},fragile]{}
 \begin{block}{Ejercicio}
\begin{itemize}
...
\label{sec:orgfac73aa}

\begin{frame}[label={sec:org3af92a1}]{Insights}
...
\begin{frame}[label={sec:org4cb9112}]{Contribución de los integrantes del equipo}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/repo_contributors_specific_graph.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:org354f568}]{Estructura de ramas de un repositorio}
\begin{center}
...
\begin{frame}[label={sec:orgc75c79b},fragile]{Página web de \alert{usuario u organización}}
 \begin{enumerate}
...
\begin{frame}[label={sec:org574a2c3}]{Ejemplo de web de \alert{organización}}
\begin{itemize}
