...
\begin{frame}[label={sec:org8d9e3f6}]{AIGORA}
...
\label{sec:org3bc50d8}
\subsection{¿Qué es el control de versiones?}
\label{sec:org563a7aa}

\begin{frame}[label={sec:orga467bb1},plain]{}
\begin{center}
...
\begin{frame}[label={sec:org75f9533},plain]{}
\begin{center}
...
\begin{frame}[label={sec:org4bde745},plain]{}
\begin{center}
...
\begin{frame}[label={sec:orgea4653e}]{¿Qué es el control de versiones y por qué debería importarte?}
\begin{quote}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgfb0ba7e}]{¿Qué es el control de versiones y por qué debería importarte?}
\begin{quote}
...
personas.\footnote{\url{https://swcarpentry.github.io/git-novice/}\label{org20bc43e}}
\end{quote}
...
\begin{frame}[label={sec:org9a210bc}]{Git es un Sistema de Control de Versiones}
...
\begin{frame}[label={sec:org64d980a}]{Git es un Sistema de Control de Versiones}
...
\begin{frame}[label={sec:org4f39bc2},fragile]{Recibir cambios de un repositorio remoto}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orgf9132f7}]{Resumen}
\begin{enumerate}
...
\begin{frame}[label={sec:orgc37c45c},fragile]{Crear una nueva rama}
 \begin{itemize}
...
\begin{frame}[label={sec:org8250507}]{Combinación de código}
\begin{center}
\includegraphics[height=0.3\textheight]{figs/branching.png}
\end{center}
...
\begin{frame}[label={sec:orgcb8d8eb}]{Combinación de código}
\begin{center}
\includegraphics[height=0.3\textheight]{figs/branching.png}
\end{center}
...
\begin{frame}[label={sec:org3e55114}]{Resolución de conflictos}
...
\begin{center}
\includegraphics[height=0.3\textheight]{figs/conflict_web.png}
\end{center}
...
\end{frame}
\begin{frame}[label={sec:orgc80e4a0},fragile]{Consejos}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:org8fdec07},fragile]{}
...
\label{sec:orgb120371}

\begin{frame}[label={sec:orgd6f790b}]{Issues}
...
\begin{frame}[label={sec:org648bca5}]{Estructura de una issue}
...
\begin{frame}[label={sec:org4353268}]{Contenido de una issue}
\begin{itemize}
...
\begin{frame}[label={sec:orga1ff2c3},fragile]{}
...
\label{sec:orga7466f4}

\begin{frame}[label={sec:orgdd438cb}]{Insights}
...
\begin{frame}[label={sec:org4084ea4}]{Contribución de los integrantes del equipo}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/repo_contributors_specific_graph.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgf636d5f}]{Estructura de ramas de un repositorio}
\begin{center}
...
\begin{frame}[label={sec:org188902e},fragile]{GitHub Classroom necesita una Organización}
 \begin{itemize}
...
\begin{frame}[label={sec:org88c2f0d},fragile]{Dentro de una organización se pueden definir equipos}
 \begin{itemize}
...
\begin{frame}[label={sec:org0753ee6},fragile]{Configuración de aulas}
 \begin{itemize}
...
\begin{frame}[label={sec:orgdb7c283},fragile]{Asignación de tareas}
 \begin{itemize}
...
\begin{frame}[label={sec:org81d0b2f},fragile]{Cómo hemos usado GitHub Classroom en AIGORA}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org86b800c},fragile]{Cómo hemos usado GitHub Classroom en AIGORA}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org89a9062},fragile]{Cómo hemos usado GitHub Classroom en AIGORA}
...
\label{sec:org2ff96bf}

\begin{frame}[label={sec:orgb639683},fragile]{Página web de \alert{proyecto}}
...
\begin{frame}[label={sec:org584c630},fragile]{Página web de \alert{proyecto}}
 \url{https://<username>.github.io/<repository>}
...
\begin{frame}[label={sec:org247ebcd}]{Ejemplo de web de \alert{proyecto}}
\begin{itemize}
...
\begin{frame}[label={sec:org66c39d1},fragile]{Página web de \alert{usuario u organización}}
 \begin{enumerate}
...
\begin{frame}[label={sec:orgc1a1b04}]{Ejemplo de web de \alert{organización}}
\begin{itemize}
