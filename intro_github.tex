...
\begin{frame}[label={sec:orgf733764}]{AIGORA}
...
\label{sec:orga2d36f0}
\subsection{¿Qué es el control de versiones?}
\label{sec:org506e31e}

\begin{frame}[label={sec:orge9d03ca},plain]{}
\begin{center}
...
\begin{frame}[label={sec:org1a2eae6},plain]{}
\begin{center}
...
\begin{frame}[label={sec:orgf3ffe82},plain]{}
\begin{center}
...
\begin{frame}[label={sec:org857b48d}]{¿Qué es el control de versiones y por qué debería importarte?}
\begin{quote}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:orga92ff60}]{¿Qué es el control de versiones y por qué debería importarte?}
\begin{quote}
...
personas.\footnote{\url{https://swcarpentry.github.io/git-novice/}\label{orgfc94463}}
\end{quote}
...
\begin{frame}[label={sec:orgfe18d3e}]{Git es un Sistema de Control de Versiones}
...
\begin{frame}[label={sec:orgb29e1d8}]{Git es un Sistema de Control de Versiones}
...
\begin{frame}[label={sec:org9952028}]{Método 1: de remoto a local}
...
\begin{frame}[label={sec:org2cec568},fragile]{Recibir cambios de un repositorio remoto}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org9254848}]{Resumen}
\begin{enumerate}
...
\label{sec:org3e23bd6}
\subsection{Ramas}
\label{sec:org407d43d}

\begin{frame}[label={sec:orgba789f0},fragile]{Rama \texttt{master}}
 \begin{center}
...
\begin{frame}[label={sec:orge171f77}]{Ramas para facilitar la colaboración}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/branching.png}
\end{center}
...
\begin{frame}[label={sec:org0b9e500},fragile]{Crear una nueva rama}
 \begin{itemize}
...
\begin{frame}[label={sec:orgc206527}]{Combinación de código}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/branching.png}
\end{center}
...
\begin{frame}[label={sec:org3136d04}]{Combinación de código}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/branching.png}
\end{center}
...
\begin{frame}[label={sec:orgd46a97a}]{Resolución de conflictos}
...
\end{frame}
\begin{frame}[label={sec:orge08ad5b},fragile]{Consejos}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgffd2f2f},fragile]{}
...
\label{sec:org1d3ccad}

\begin{frame}[label={sec:org7a94290}]{Issues}
...
\begin{frame}[label={sec:org3a29f9e}]{Estructura de una issue}
...
\begin{frame}[label={sec:org2d55be0}]{Contenido de una issue}
\begin{itemize}
...
\begin{frame}[label={sec:org045e1a7},fragile]{}
 \begin{block}{Ejercicio}
\begin{itemize}
...
\label{sec:org0dad65f}

\begin{frame}[label={sec:org7a6deee}]{Insights}
...
\begin{frame}[label={sec:org51029fe}]{Contribución de los integrantes del equipo}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/repo_contributors_specific_graph.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:org6d398fd}]{Estructura de ramas de un repositorio}
\begin{center}
...
\begin{frame}[label={sec:orgb1e2e18},fragile]{GitHub Classroom necesita una Organización}
 \begin{itemize}
...
\begin{frame}[label={sec:orgb257c07},fragile]{Dentro de una organización se pueden definir equipos}
 \begin{itemize}
...
\begin{frame}[label={sec:orgc86c27b},fragile]{Configuración de aulas}
 \begin{itemize}
...
\begin{frame}[label={sec:org2c0e0e5},fragile]{Asignación de tareas}
 \begin{itemize}
...
\begin{frame}[label={sec:org3c92271},fragile]{Cómo hemos usado GitHub Classroom en AIGORA}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org0e0155d},fragile]{Cómo hemos usado GitHub Classroom en AIGORA}
...
\end{block}
\end{frame}
\begin{frame}[label={sec:org048f96d},fragile]{Cómo hemos usado GitHub Classroom en AIGORA}
...
\label{sec:org3602790}

\begin{frame}[label={sec:orgbd54bd1},fragile]{Página web de \alert{proyecto}}
...
\begin{frame}[label={sec:orgea2b41e},fragile]{Página web de \alert{proyecto}}
 \url{https://<username>.github.io/<repository>}
...
\begin{frame}[label={sec:org984b707}]{Ejemplo de web de \alert{proyecto}}
\begin{itemize}
...
\begin{frame}[label={sec:org50c378d},fragile]{Página web de \alert{usuario u organización}}
 \begin{enumerate}
...
\begin{frame}[label={sec:org8dd7f36}]{Ejemplo de web de \alert{organización}}
\begin{itemize}
