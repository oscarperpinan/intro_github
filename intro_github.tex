...
\label{sec:org3a84a14}
\subsection{¿Qué es el control de versiones?}
\label{sec:orge0ffcdf}

\begin{frame}[label={sec:org82876a3},plain]{}
\begin{center}
...
\begin{frame}[label={sec:orgeadbc6b},plain]{}
\begin{center}
...
\begin{frame}[label={sec:org18d9406},plain]{}
\begin{center}
...
\begin{frame}[label={sec:org7a42aa1}]{¿Qué es el control de versiones y por qué debería importarte?}
\begin{quote}
...
\begin{frame}[label={sec:org3c2de64}]{¿Qué es el control de versiones y por qué debería importarte?}
\begin{quote}
...
\begin{frame}[label={sec:orgbefcd7b}]{Viajar en el tiempo}
\begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orge4fbc22}]{¿Qué? ¿Cuándo? ¿Quién?}
...
\begin{frame}[label={sec:org301b6db}]{Trabajo Colaborativo}
\begin{itemize}
...
\label{sec:orga0a1536}

\begin{frame}[label={sec:org2b106f5},fragile]{Git es un Sistema de Control de Versiones}
...
\begin{frame}[label={sec:org35272a3}]{Git es un Sistema de Control de Versiones}
...
\begin{frame}[label={sec:org9491395}]{Git es un Sistema de Control de Versiones}
...
\begin{frame}[label={sec:org55865ec}]{Los estados de Git}
\begin{itemize}
...
\begin{frame}[label={sec:org3466071},fragile]{¿Qué es GitHub?}
 \begin{itemize}
...
\label{sec:orgdb07c32}

\subsection{Primeros Pasos}
\label{sec:orgd946bfb}
\begin{frame}[label={sec:org560ffd2}]{Creación de una cuenta en GitHub}
...
\begin{frame}[label={sec:org09f0fe4}]{Instalación de GitHub Desktop}
...
\begin{frame}[label={sec:org71f86d3}]{Conectamos Git, GitHub y GitHub Desktop}
\begin{itemize}
...
\begin{frame}[label={sec:orgba6a73f}]{Nuevo repositorio desde github.com}
...
\begin{frame}[label={sec:org79d2441}]{Nuevo repositorio desde GitHub Desktop}
\begin{center}
...
\begin{frame}[label={sec:org645a3aa}]{Clonar un repositorio remoto}
...
\begin{frame}[label={sec:orge3093d9}]{Publicar un repositorio local}
...
\begin{frame}[label={sec:orga23c75c},fragile]{Consejos básicos}
 \begin{itemize}
...
\label{sec:org8cc5e0f}

\begin{frame}[label={sec:org51e64cf},fragile]{Cambios en la copia local}
 \begin{itemize}
...
\begin{frame}[label={sec:org184004e},fragile]{Histórico de cambios}
...
\begin{frame}[label={sec:orgd3b3ae4},fragile]{Publicar cambios al repositorio remoto}
 \begin{itemize}
...
\end{itemize}
\end{frame}
\begin{frame}[label={sec:orgb45545e},fragile]{Recibir cambios de un repositorio remoto}
...
\label{sec:org06223a8}

\subsection{Ramas}
\label{sec:org21a66fc}

\begin{frame}[label={sec:orgb28f588},fragile]{Rama \texttt{master}}
 \begin{center}
...
\begin{frame}[label={sec:org3b3f64c}]{Ramas para facilitar la colaboración}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/branching.png}
\end{center}
...
\begin{frame}[label={sec:orgf640c90}]{Combinación de código}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/branching.png}
\end{center}
...
\begin{frame}[label={sec:org96f6b51}]{Combinación de código}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/branching.png}
\end{center}
...
\begin{frame}[label={sec:org23f8715}]{Resolución de conflictos}
...
\begin{frame}[label={sec:orgd3921f3}]{Consejos}
\begin{itemize}
...
\label{sec:org59da31c}

\begin{frame}[label={sec:orgaa16896}]{Issues}
...
\begin{frame}[label={sec:orga8f5934}]{Estructura de una issue}
...
\begin{frame}[label={sec:org05daea7}]{Contenido de una issue}
\begin{itemize}
...
\label{sec:orge34bdd9}

\begin{frame}[label={sec:orgf2480fe}]{Insights}
...
\begin{frame}[label={sec:orgc7c4bc0}]{Contribución de los integrantes del equipo}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/repo_contributors_specific_graph.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgbaf36af}]{Estructura de ramas de un repositorio}
\begin{center}
\includegraphics[width=.9\linewidth]{figs/repo_network_graph.png}
\end{center}
\end{frame}

\begin{frame}[label={sec:orgbfbe6e5}]{Cambios en un repositorio}
\begin{center}
...
\label{sec:orgeee9d91}

\begin{frame}[label={sec:org04ddb50},fragile]{Página web de usuario u organización}
 \begin{enumerate}
...
\begin{frame}[label={sec:org2e14593},fragile]{Página web de proyecto}
...
\begin{frame}[label={sec:org7d0fd46},fragile]{Página web de proyecto}
